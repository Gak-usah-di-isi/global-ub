...
@section('content')
    <div class="space-y-6">
        ...
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Edit Event</span>
        </nav>
        ...
        <form id="edit-form" action="{{ route('events.update', $event->slug) }}" method="POST"
            ...
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                ...
                <div class="space-y-7">
                    ...
                    <div>
                        <label for="expected_attendees" class="field-label req">
                            Expected Number of Attendees
                        </label>
                        <input id="expected_attendees" name="expected_attendees" type="number"
                            value="{{ old('expected_attendees', $event->expected_attendees) }}" required
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="help-text">
                            Optional event image (JPEG, PNG, GIF). Maximum size: 5MB
                        </p>
                    </div>
