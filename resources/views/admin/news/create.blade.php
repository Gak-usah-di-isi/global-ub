...
@section('content')
    <div class="space-y-6">
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Create News</span>
        </nav>
        ...
        @endif
        <form id="create-form" action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-8">
            @csrf
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                ...
                <div class="space-y-7">
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="help-text">
                            Supported formats: JPEG, PNG, JPG, GIF, SVG. Maximum size: 5MB
                        </p>
                    </div>
                </div>
            </section>
