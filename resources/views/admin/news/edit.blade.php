...
@section('content')
    <div class="space-y-6">
        ...
        @endif
        <form id="edit-form" action="{{ route('news.update', $newsItem->slug) }}" method="POST"
            ...
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                ...
                <div class="space-y-7">
                    <div>
                        ...
                        <input id="title" name="title" type="text" value="{{ old('title', $newsItem->title) }}"
                    ...
                    <div>
                        ...
                        <input id="created_at" name="created_at" type="datetime-local"
                            value="{{ old('created_at', $newsItem->created_at->format('Y-m-d\TH:i')) }}"
                        ...
                        @enderror
                        <p class="help-text">
                            Set the date and time when this news should appear as published.
                        </p>
                    </div>
                    ...
                    @if ($newsItem->image)
                        <div>
                            ...
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $newsItem->image) }}" alt="Current News Image"
