...
@section('title', 'Dashboard - Create Ranking')
...
@section('content')
    <div class="space-y-6">
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Create Ranking</span>
        </nav>
        ...
        @endif
        <form id="create-form" action="{{ route('rankings.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-8">
            @csrf
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                ...
                <div class="space-y-7">
                    ...
                    <div>
                        ...
                        <input id="year" name="year" type="text" value="{{ old('year', date('Y')) }}"
                    ...
                    <div>
                        ...
                        <input id="order" name="order" type="number" value="{{ old('order', 0) }}" min="0"
                            placeholder="0"
