...
@section('title', 'Dashboard - Edit Merchandise')
...
@section('content')
    <div class="space-y-6">
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Edit Merchandise</span>
        </nav>
            ...
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                ...
                <div class="space-y-7">
                    <div>
                        ...
                        <input id="name" name="name" type="text" value="{{ old('name', $merchandise->name) }}"
                    ...
                    <div>
                        ...
                        <input id="category" name="category" type="text"
                            value="{{ old('category', $merchandise->category) }}" placeholder="Enter category"
                    ...
                    <div>
                        ...
                        <input id="price" name="price" type="number" value="{{ old('price', $merchandise->price) }}"
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="help-text">
                            Leave empty to keep current image. Supported formats: JPG, JPEG, PNG, GIF. Max size: 2MB
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input id="shopee_link" name="shopee_link" type="url"
                                value="{{ old('shopee_link', $merchandise->shopee_link) }}"
                        ...
                        <div>
                            ...
                            <input id="tokopedia_link" name="tokopedia_link" type="url"
                                value="{{ old('tokopedia_link', $merchandise->tokopedia_link) }}"
