...
@section('title', 'Dashboard - Programs')
...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-card p-4">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
            <h2 class="text-[15px] font-medium text-slate-800">Programs</h2>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="{{ route('programs.destroy', $program->slug) }}" method="POST"
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-8 text-slate-500">
                                <div class="flex flex-col items-center gap-2">
                                    <svg class="w-4 h-4 {{ request()->routeIs('programs.*') ? 'text-primary-600' : 'text-slate-600' }}"
