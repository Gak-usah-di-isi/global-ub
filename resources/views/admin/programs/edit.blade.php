...
@section('title', 'Dashboard - Edit Program')
...
@section('content')
    <div class="space-y-6">
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Edit Program</span>
        </nav>
    </div>
    ...
    <form id="edit-form" action="{{ route('programs.update', $program->slug) }}" method="POST"
        ...
        <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
            ...
            <div class="space-y-7">
                <div>
                    ...
                    <input id="title" name="title" type="text" value="{{ old('title', $program->title) }}" required
                ...
                <div>
                    ...
                    <input id="program_type" name="program_type" type="text"
                        value="{{ old('program_type', $program->program_type) }}" required placeholder="Enter program type"
                ...
                <div>
                    ...
                    <input id="link" name="link" type="url" value="{{ old('link', $program->link) }}"
                ...
                <div>
                    ...
                    <div id="references-container" class="space-y-3 mt-2">
                        @php
                            $existingReferences = old('references', $program->references ?? []);
                ...
                @if ($program->image)
                    <div>
                        ...
                        <div class="mt-2">
                            <img src="{{ asset('storage/' . $program->image) }}" alt="Current Program Image"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let referenceCount = referencesContainer.querySelectorAll('.reference-item').length;
