...
@section('title', 'Dashboard - Edit Gallery')
...
@section('content')
    <div class="space-y-6">
        ...
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Edit Gallery</span>
        </nav>
        ...
        <form id="edit-form" action="{{ route('galleries.update', $gallery->slug) }}" method="POST"
            ...
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                ...
                <div class="space-y-7">
                    <div>
                        ...
                        <input id="title" name="title" type="text" value="{{ old('title', $gallery->title) }}"
                    ...
                    <div>
                        ...
                        <input id="category_gallery" name="category_gallery" type="text"
                            value="{{ old('category_gallery', $gallery->category_gallery) }}" required
