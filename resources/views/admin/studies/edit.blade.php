...
@section('title', 'Dashboard - Edit Study Program')
...
@section('content')
    <div class="space-y-6">
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Edit Study Program</span>
        </nav>
        ...
        @endif
        <form id="edit-form" action="{{ route('studies.update', $study->slug) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                ...
                <div class="space-y-7">
                    <div>
                        ...
                        <input id="title" name="title" type="text" value="{{ old('title', $study->title) }}"
                    ...
                    <div>
                        ...
                        <input id="tagline" name="tagline" type="text" value="{{ old('tagline', $study->tagline) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
                        <div>
                            ...
                            <input id="students_count" name="students_count" type="number"
                                value="{{ old('students_count', $study->students_count) }}"
                        ...
                        <div>
                            ...
                            <input id="duration" name="duration" type="text"
                                value="{{ old('duration', $study->duration) }}" placeholder="e.g., 4 years, 2 semesters"
                    ...
                    <div>
                        ...
                        <input id="icon_class" name="icon_class" type="text"
                            value="{{ old('icon_class', $study->icon_class) }}"
