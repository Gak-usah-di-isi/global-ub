                ...
                <tbody>
                    @forelse($studies as $study)
                        <tr>
                            ...
                            <td>{{ $study->title }}</td>
                            <td>{{ $study->tagline ? \Illuminate\Support\Str::limit($study->tagline, 10) : '-' }}</td>
                            <td>{{ $study->description ? \Illuminate\Support\Str::limit($study->description, 10) : 'No description' }}
                            </td>
