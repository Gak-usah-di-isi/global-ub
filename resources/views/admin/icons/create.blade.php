...
@section('title', 'Dashboard - Create Icons')
...
@section('content')
    <div class="space-y-6">
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Create Icons</span>
        </nav>
        ...
        <form id="create-form" action="{{ route('icons.store') }}" method="POST" enctype="multipart/form-data"
            class="space-y-8">
            @csrf
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                <h2 class="section-title">Icons Information</h2>
