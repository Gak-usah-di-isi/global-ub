...
@section('title', 'Dashboard - Edit Partnership')
...
@section('content')
    <div class="space-y-6">
        ...
        <nav class="text-[12px] font-medium flex items-center gap-1 text-slate-500">
            ...
            <span class="text-slate-700">Edit Partnership</span>
        </nav>
        ...
        <form id="edit-form" action="{{ route('partnerships.update', $partnership->slug) }}" method="POST"
            ...
            <section class="bg-white shadow-card rounded-xl p-6 md:p-8">
                ...
                <div class="space-y-7">
                    <div>
                        ...
                        <input id="name" name="name" type="text" value="{{ old('name', $partnership->name) }}"
                            required placeholder="Enter partnership name"
                    ...
                    <div>
                        ...
                        <input id="website" name="website" type="url"
                            value="{{ old('website', $partnership->website) }}" placeholder="https://example.com"
                        ...
                        <div>
                            ...
                            <div class="mt-2 p-3 bg-slate-50 rounded-lg flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm text-slate-600">Current logo</span>
                                </div>
                            </div>
                            <p class="help-text mt-2">
                                Upload a new logo below to replace the current one
                            </p>
                        </div>
                    @endif
                    ...
                    <div>
                        <label for="logo" class="field-label">
                            {{ $partnership->logo ? 'Replace Logo' : 'Partnership Logo' }}
                        </label>
                        <div class="mt-2">
                        ...
                        <p class="help-text">
                            ...
                            {{ $partnership->logo ? 'Leave empty to keep current logo.' : '' }}
                        </p>

                        <!-- Logo Preview -->
                        <div id="logo-preview" class="hidden mt-3">
                            <label class="field-label">New Logo Preview</label>
                            <img id="preview-img"
