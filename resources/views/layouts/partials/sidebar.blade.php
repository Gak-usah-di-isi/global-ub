<aside id="sidebar"
    ...
    {{ request()->routeIs('dashboard') ? 'bg-primary-50 text-primary-700 border-l-2 border-primary-500' : 'text-slate-800 hover:bg-slate-50' }}">
            ...
            <a href="{{ route('visitor-statistics.index') }}"
                class="sidebar-menu-item w-full h-10 flex items-center gap-3 text-left text-[15px] font-semibold px-2 rounded-[4px] transition duration-150
    {{ request()->routeIs('visitor-statistics.*') ? 'bg-primary-50 text-primary-700 border-l-2 border-primary-500' : 'text-slate-800 hover:bg-slate-50' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('visitor-statistics.*') ? 'text-primary-600' : 'text-slate-600' }}"
                    fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <span class="nav-label">Visitor Statistics</span>
            </a>
            ...
            <a href="{{ route('rankings.index') }}"
                class="sidebar-menu-item w-full h-10 flex items-center gap-3 text-left text-[15px] font-semibold px-2 rounded-[4px] transition duration-150 
            {{ request()->routeIs('rankings.*') ? 'bg-primary-50 text-primary-700 border-l-2 border-primary-500' : 'text-slate-800 hover:bg-slate-50' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('rankings.*') ? 'text-primary-600' : 'text-slate-600' }}"
                    fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
   ...
   {{ request()->routeIs('events.*')
       ...
       : 'text-slate-800 hover:bg-s  
            ...
            <a href="{{ route('programs.index') }}"
                class="sidebar-menu-item w-full h-10 flex items-center gap-3 text-left text-[15px] font-semibold px-2 rounded-[4px] transition duration-150 
                {{ request()->routeIs('programs.*') ? 'bg-primary-50 text-primary-700 border-l-2 border-primary-500' : 'text-slate-800 hover:bg-slate-50' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('programs.*') ? 'text-primary-600' : 'text-slate-600' }}"
                    fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('merchandise.index') }}"
                class="sidebar-menu-item w-full h-10 flex items-center gap-3 text-left text-[15px] font-semibold px-2 rounded-[4px] transition duration-150 
                {{ request()->routeIs('merchandise.*') ? 'bg-primary-50 text-primary-700 border-l-2 border-primary-500' : 'text-slate-800 hover:bg-slate-50' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('merchandise.*') ? 'text-primary-600' : 'text-slate-600' }}"
                    fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M4 6h16M4 12h16M4 18h16M6 4v16M12 4v16M18 4v16"></path>
                </svg>
