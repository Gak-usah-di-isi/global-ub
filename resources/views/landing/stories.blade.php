...
<html lang="en">
 ...
 <head>
    ...
    <title>Watch Their Stories Page</title>
        ...
        <section id="study-in-ub"
            ...
            <div class="max-w-[1280px] mx-auto flex flex-col gap-8 md:gap-12 lg:gap-16">
                ...
                <div class="w-full flex flex-col items-center gap-4">
                    ...
                    <p class="text-center font-inter font-light text-base md:text-lg lg:text-xl leading-6 md:leading-7 lg:leading-[28px] text-[#29303DB2]">
                ...
                <div class="w-full mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <article class="story-card w-full max-w-[380px] h-auto bg-white rounded-[16px] shadow-[0px_4px_20px_-2px_#29303D1A] overflow-hidden cursor-pointer transition-transform hover:scale-105" 
                             data-video="dQw4w9WgXcQ" 
                             data-title="International Student Experience"
                        ...
                        <div class="w-full h-48 relative group">
                            <img src="{{ asset('images/story1.png') }}" alt="International Student Story" class="w-full h-full object-cover">
                        ...
                        <div class="w-full h-auto p-4 sm:p-6 flex flex-col gap-4">
                            <div class="w-full flex items-center justify-between">
                                <p class="inline-flex items-center rounded-full px-2 py-1 text-xs leading-[16px] font-medium bg-[#D7E4FF] text-[#1D4ED8]">
                                    Student Story
                                </p>
                            </div>
                            <h3 class="font-playfair font-bold text-lg lg:text-xl leading-relaxed md:leading-[28px] text-[#29303D]">
                                International Student Experience
                            </h3>
                            <p class="font-inter text-sm md:text-base lg:text-base font-normal leading-normal text-[#29303D] opacity-[0.7]">
                                Sarah shares her journey from Malaysia to UB and how she found her passion in engineering.
                            </p>
                        </div>
                    </article>

                    <article class="story-card w-full max-w-[380px] h-auto bg-white rounded-[16px] shadow-[0px_4px_20px_-2px_#29303D1A] overflow-hidden cursor-pointer transition-transform hover:scale-105" 
                             data-video="jNQXAC9IVRw" 
                             data-title="Research Collaboration Success"
                             data-description="Dr. Ahmed discusses breakthrough research projects with international partners.">
                        <div class="w-full h-48 relative group">
                            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=300&fit=crop" alt="Research Story" class="w-full h-full object-cover">
                            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div class="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                                  <img src="{{ asset('icons/play1.svg') }}" alt="Play Button" class="w-6 h-6 ml-1">
                                </div>
                    ...
                    <article class="story-card w-full max-w-[380px] h-auto bg-white rounded-[16px] shadow-[0px_4px_20px_-2px_#29303D1A] overflow-hidden cursor-pointer transition-transform hover:scale-105" 
                             ...
                             data-title="Cultural Exchange Program"
                             data-description="Maria talks about her transformative cultural exchange experience at UB.">
                        <div class="w-full h-48 relative group">
                            <img src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=400&h=300&fit=crop" alt="Cultural Exchange Story" class="w-full h-full object-cover">
                            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div class="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                                  <img src="{{ asset('icons/play1.svg') }}" alt="Play Button" class="w-6 h-6 ml-1">
                                </div>
                    ...
                    <article class="story-card w-full max-w-[380px] h-auto bg-white rounded-[16px] shadow-[0px_4px_20px_-2px_#29303D1A] overflow-hidden cursor-pointer transition-transform hover:scale-105" 
                        ...
                        <div class="w-full h-48 relative group">
                            <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=300&fit=crop" alt="Alumni Success Story" class="w-full h-full object-cover">
                            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div class="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                                  <img src="{{ asset('icons/play1.svg') }}" alt="Play Button" class="w-6 h-6 ml-1">
                                </div>
                ...
                <div class="w-full flex justify-center items-center py-8">
                    <div class="flex items-center gap-4">
                        <button class="w-10 h-10 md:w-12 md:h-12 bg-[#FFFFFF] rounded-full flex justify-center items-center shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <div class="flex items-center gap-2 md:gap-4 bg-[#FFFFFF] rounded-full p-1 md:p-2 shadow-md">
                            ...
                            <button class="w-7 h-7 md:w-9 md:h-9 text-[#1D4ED8] flex justify-center items-center text-sm md:text-base hover:bg-blue-50 rounded-full transition-colors">
                                2
                            </button>
