...
<section class="lg:max-w-6xl flex-col lg:flex-row items-center align-middle mx-auto py-10 lg:pt-20 lg:pb-16 px-4 sm:px-6 lg:px-8">
    <div class="flex flex-col lg:flex-row gap-8 items-start w-full justify-between gap-x-10">
        ...
        <div class="lg:w-7/12 gap-4 w-full justify-between flex h-auto flex-col">
            <div class="">
                <span class="py-1 px-4 text-sm text-blue-700 font-inter mb-4 w-fit block bg-blue-50 font-normal rounded-full">Education Fair</span>
                <h1 class="font-bold text-3xl mb-4 font-playfair">International Education Fair 2024</h1>
                <p class="font-inter max-w-xl text-neutral-500 leading-6">Join us at the International Education Fair 2024 to meet representatives from leading universities around the world. Discover study abroad opportunities, explore scholarship options, and gain valuable insights into international programs, admissions processes, and career pathways. This is your chance to connect directly with global education experts and plan your academic future with confidence</p>
                <div class="flex flex-col gap-1 text-neutral-500 my-4">
                    <span class="flex items-center align-middle gap-2"><img src="{{asset('icons/calender.svg')}}" alt="calendrr">Thursday, February 15, 2024</span>
                    <span class="flex items-center align-middle gap-2"><img src="{{asset('icons/clock.svg')}}" alt="clock">09:00 - 17:00</span>
                    <span class="flex items-center align-middle gap-2"><img src="{{asset('icons/location.svg')}}" alt="location">UB Convention Center</span>
                    <span class="flex items-center align-middle text-neutral-500 gap-2"><img src="{{asset('icons/user-black.svg')}}" alt="people">500+ Expected Attendance</span>
                </div>
                <a class="inline-block bg-white text-neutral-800 border border-neutral-200 shadow-[0px_4px_20px_-2px_#29303D1A] font-inter w-fit py-3 font-medium px-8 rounded-xl mb-4">Register Now</a>
            </div>
    ...
    <div class="w-full grid grid-cols-1 py-8 lg:py-16 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <article
            ...
            <div class="flex flex-col flex-1 p-6 gap-4">
                ...
                <div class="flex items-center justify-between">
                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-[#DCFCE7] text-[#15803D]">
                        Education Fair
                    </span>
                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-[#DCFCE7] text-[#15803D]">
                        Upcoming
        ...
        <article
            ...
            <div class="flex flex-col flex-1 p-6 gap-4">
                <!-- badges -->
                <div class="flex items-center justify-between">
                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-[#EDE9FE] text-[#6D28D9]">
                        Symposium
                    </span>
                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-[#DCFCE7] text-[#15803D]">
                        Upcoming
        ...
        <article
            ...
            <div class="flex flex-col flex-1 p-6 gap-4">
                <!-- badges -->
                <div class="flex items-center justify-between">
                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-[#FCE7F3] text-[#DB2777]">
                        Cultural Event
                    </span>
                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium bg-[#DCFCE7] text-[#15803D]">
                        Upcoming
