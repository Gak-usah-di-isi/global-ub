    ...
    <section x-data="{
                ...
                <h1
                    ...
                    <template x-for="(slide, index) in slides" :key="index">
                        <span x-show="currentSlide === index" x-transition:enter="transition ease-in-out duration-500"
                            ...
                            x-transition:leave-end="opacity-0" x-html="slide.title"></span>
                    </template>
                </h1>
                <h2
                    ...
                    <template x-for="(slide, index) in slides" :key="index">
                        <span x-show="currentSlide === index" x-transition:enter="transition ease-in-out duration-500"
                            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                            x-transition:leave="transition ease-in-out duration-500" x-transition:leave-start="opacity-100"
                            x-transition:leave-end="opacity-0" x-html="slide.subtitle"></span>
                    </template>
                </h2>
                <div class="flex flex-col sm:flex-row gap-3 justify-center ipad-pro:justify-center lg:justify-start">
                    <a href="{{ route('event.index') }}"
                        ...
                        <span class="font-medium font-inter text-sm sm:text-[14px] leading-[24px] text-white">Explore
                            Programs</span>
                        <img src="{{ asset(config('app.icon_path') . '/play.svg') }}" alt="Play Icon" class="w-4 h-4">
                    </a>
        ...
        <div
            ...
            <button @click="prevSlide()" class="w-12 h-12 flex justify-center items-center text-white">
                <img src="{{ asset(config('app.icon_path') . '/left-arrow.svg') }}" alt="Previous" class="w-6 h-6">
            </button>
        </div>
        <div
            ...
            <button @click="nextSlide()" class="w-12 h-12 flex justify-center items-center text-white">
                <img src="{{ asset(config('app.icon_path') . '/right-arrow.svg') }}" alt="Next" class="w-6 h-6">
            </button>
        </div>
                ...
                <div class="mt-6 md:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="flex items-center gap-2">
                        <div
                            ...
                            <img src="{{ asset(config('app.icon_path') . '/user.svg') }}" alt="Students Icon"
                                class="w-[24px] h-[24px]" />
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-2">
                        <div
                            class="w-10 h-10 md:w-[48px] md:h-[48px] bg-gradient-to-r from-[#0000FF] to-[#6699FF] rounded-[12px] flex items-center justify-center">
                            <img src="{{ asset(config('app.icon_path') . '/book.svg') }}" alt="Programs Icon"
                                class="w-[24px] h-[24px]" />
                        </div>
                        <div>
                    ...
                    <div
                        ...
                        <header class="flex items-center gap-4">
                            <div class="relative">
                                ...
                                <img src="{{ asset(config('app.icon_path') . '/star_testi.svg') }}" alt="Badge icon"
                        ...
                        <blockquote class="mt-4">
                            <img src="{{ asset(config('app.icon_path') . '/quote.svg') }}" alt="Quote icon"
                        ...
                        <section class="mt-4 space-y-2 text-xs sm:text-sm text-gray-500 font-inter">
                            <p class="flex items-center gap-2">
                                <img src="{{ asset(config('app.icon_path') . '/location.svg') }}" alt="Location icon"
                                    class="w-4 h-4" />
                                {{ $testimonial->location }}
                            </p>
                            <p class="flex items-center gap-2">
                                <img src="{{ asset(config('app.icon_path') . '/education.svg') }}" alt="Calendar icon"
                                    class="w-4 h-4" />
