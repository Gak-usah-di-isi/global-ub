...
<div class="max-w-[1440px] mx-auto">
    <!-- Hero Section -->
    <section class="relative w-full h-[700px] md:h-[600px] sm:h-[500px] max-w-[1440px] mx-auto">
        ...
        <div class="absolute top-1/2 transform -translate-y-1/2 w-full flex flex-col lg:flex-row items-center justify-between px-4 sm:px-8 lg:px-[120px] gap-8 lg:gap-0">
            <!-- Text Container -->
            <div class="text-container flex flex-col gap-4 lg:gap-[24px] text-center lg:text-left max-w-full lg:max-w-[779px]">
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-[72px] font-bold leading-tight lg:leading-[72px] tracking-normal text-white font-playfair">
                    Inspiring Change,<br><span class="text-[#6699FF]">Uniting Civilizations</span>
                </h1>
                <h2 class="text-lg sm:text-xl lg:text-[24px] font-light leading-relaxed lg:leading-[24px] text-white font-inter tracking-normal">
                    Leading research and innovation on the global stage
                </h2>

                <!-- Buttons -->
                <div class="flex flex-col sm:flex-row gap-4 lg:gap-[8px] justify-center lg:justify-start">
                    <button class="bg-[#FFFFFF1A] border border-[#FFFFFF33] shadow-[0px_8px_25px_-8px_#0000FF4D] backdrop-blur-[4px] text-[#0000FF] py-3 px-6 lg:px-[33px] rounded-[12px] w-full sm:w-auto lg:w-[220px] h-[56px] flex items-center justify-center gap-2">
                        <span class="font-medium font-inter text-[14px] leading-[24px] text-white">Explore Programs</span>
                        <img src="{{ asset('icons/play.svg') }}" alt="Play Icon" class="w-6 h-6">
                    </button>

                    <button class="bg-[#FFFFFF1A] border border-[#FFFFFF4D] shadow-[0px_8px_25px_-8px_#0000FF4D] backdrop-blur-[4px] text-[#0000FF] py-3 px-6 lg:px-[41px] rounded-[12px] w-full sm:w-auto lg:w-[179px] h-[56px] flex items-center justify-center">
                        <span class="font-medium font-inter text-[14px] leading-[24px] text-white">Watch Video</span>
                    </button>
                </div>
            </div>

            <!-- Image Container -->
            <div class="image-container w-full max-w-[320px] sm:max-w-[350px] lg:w-[380px] h-[280px] sm:h-[320px] lg:h-[390px] rounded-[20px] overflow-hidden mt-8 lg:mt-0">
                <img src="{{ asset('/images/hero-content.jpg') }}" alt="Image" class="w-full h-full object-cover">
            </div>
        </div>

        <!-- Navigation Arrows - Hidden on mobile -->
        <div class="hidden lg:block absolute top-1/2 left-7 transform -translate-y-1/2 p-2 bg-[#FFFFFF1A] rounded-full shadow-[0px_8px_25px_-8px_#0000FF4D] backdrop-blur-[4px]">
        ...
        <div class="hidden lg:block absolute top-1/2 right-7 transform -translate-y-1/2 p-2 bg-[#FFFFFF1A] rounded-full shadow-[0px_8px_25px_-8px_#0000FF4D] backdrop-blur-[4px]">
            <button class="w-12 h-12 flex justify-center items-center text-white">
        ...
        <!-- Carousel Indicators -->
        <div class="absolute bottom-4 lg:bottom-8 left-1/2 transform -translate-x-1/2 flex gap-2">
    ...
    <section class="w-full bg-[#F0F2F4] py-12 lg:py-20">
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-2xl sm:text-3xl lg:text-[38px] font-extrabold text-center text-[#29303D] font-playfair">
                University Ranking
            </h1>
            <h2 class="text-base sm:text-lg lg:text-[20px] font-inter font-normal text-center text-[#29303DB2] mt-2 mb-8 px-4">
                Recognized globally for academic excellence and research innovation
            </h2>

            <!-- Ranking Cards Grid -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mt-8 lg:mt-16">
                <!-- Card 1 -->
                <div class="bg-white rounded-lg shadow-[0px_4px_20px_-2px_#29303D1A] p-6 lg:p-8 flex flex-col items-center">
                    <div class="w-[64px] h-[64px] bg-[#F9FAFB] rounded-full flex justify-center items-center mb-4">
                        <img src="{{ asset('icons/trophy.svg') }}" alt="Icon 1" class="w-[32px] h-[32px] opacity-100" />
                    </div>
                    <h3 class="text-xl lg:text-[24px] font-inter font-bold text-[#29303D] text-center mt-2 mb-2">Top 5</h3>
                    <p class="font-inter font-bold text-center mb-2 text-[#29303DCC] text-sm lg:text-base">Indonesia Universities</p>
                    <p class="text-[#29303D99] text-center mb-2 font-normal text-[12px] lg:text-[14px] leading-[18px] lg:leading-[20px] tracking-normal">
                        QS World University Rankings
                    </p>
                    <span class="font-medium text-[#0000FF] text-sm lg:text-base">2024</span>
                </div>

                <!-- Card 2 -->
                <div class="bg-white rounded-lg shadow-[0px_4px_20px_-2px_#29303D1A] p-6 lg:p-8 flex flex-col items-center">
                    <div class="w-[64px] h-[64px] bg-[#F9FAFB] rounded-full flex justify-center items-center mb-4">
                        <img src="{{ asset('icons/globe-blue.svg') }}" alt="Icon 2" class="w-[32px] h-[32px] opacity-100" />
                    </div>
                    <h3 class="text-xl lg:text-[24px] font-inter font-bold text-[#29303D] text-center mt-2 mb-2">#401-450</h3>
                    <p class="text-[#29303DCC] font-inter font-bold text-center mb-2 text-sm lg:text-base">World Universities</p>
                    <p class="text-[#29303D99] text-center mb-2 font-normal text-[12px] lg:text-[14px] leading-[18px] lg:leading-[20px] tracking-normal">
                        QS World University Rankings
                    </p>
                    <span class="font-medium text-[#0000FF] text-sm lg:text-base">2024</span>
                ...
                <div class="bg-white rounded-lg shadow-[0px_4px_20px_-2px_#29303D1A] p-6 lg:p-8 flex flex-col items-center">
                    <div class="w-[64px] h-[64px] bg-[#F9FAFB] rounded-full flex justify-center items-center mb-4">
                        <img src="{{ asset('icons/up.svg') }}" alt="Icon 3" class="w-[32px] h-[32px] opacity-100" />
                    </div>
                    <h3 class="text-xl lg:text-[24px] font-inter font-bold text-[#29303D] text-center mt-2 mb-2">Top 3</h3>
                    <p class="text-[#29303DCC] font-inter font-bold text-center mb-2 text-sm lg:text-base">Research Impact</p>
                    <p class="text-[#29303D99] text-center mb-2 font-normal text-[12px] lg:text-[14px] leading-[18px] lg:leading-[20px] tracking-normal">
                ...
                <div class="bg-white rounded-lg shadow-[0px_4px_20px_-2px_#29303D1A] p-6 lg:p-8 flex flex-col items-center">
                    <div class="w-[64px] h-[64px] bg-[#F9FAFB] rounded-full flex justify-center items-center mb-4">
                        <img src="{{ asset('icons/star.svg') }}" alt="Icon 4" class="w-[32px] h-[32px] opacity-100" />
                    </div>
                    <h3 class="text-xl lg:text-[24px] font-inter font-extrabold text-[#29303D] text-center mt-2 mb-2">5 Stars</h3>
                    <p class="text-[#29303DCC] font-inter font-bold text-center mb-2 text-sm lg:text-base">Overall Rating</p>
                    <p class="text-[#29303D99] text-center mb-2 font-normal text-[12px] lg:text-[14px] leading-[18px] lg:leading-[20px] tracking-normal">
                        QS Stars Rating
                    </p>
                    <span class="font-medium text-[#0000FF] text-sm lg:text-base">2024</span>
            ...
            <div class="flex justify-center mt-8 lg:mt-16">
                <button class="bg-[#FFFFFFB2] text-[#29303D] py-3 px-6 lg:py-[12px] lg:px-[24px] rounded-full w-full max-w-[504px] h-auto lg:h-[48px] flex items-center justify-center gap-2 lg:gap-[5px] mx-4 lg:mx-0">
                    <img src="{{ asset('icons/up.svg') }}" alt="Arrow Right Icon" class="w-4 h-4 lg:w-5 lg:h-5">
                    <span class="font-medium font-inter text-[12px] sm:text-[13px] lg:text-[14px] leading-[20px] lg:leading-[24px] text-center">
    ...
    <!-- About Section -->
    <section class="w-full bg-white pt-12 lg:pt-20 px-4 sm:px-8 lg:px-[112px] pb-12 lg:pb-0">
        <div class="max-w-[1440px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-[64px]">
            <!-- Left Container: About -->
            <div class="w-full lg:w-[576px]">
                <h2 class="text-2xl sm:text-3xl lg:text-[36px] font-playfair font-extrabold leading-tight lg:leading-[48px] text-[#29303D] text-center lg:text-left">
                    About Globalizing UB
                </h2>
                <p class="mt-4 text-base lg:text-[18px] font-light font-inter leading-relaxed lg:leading-[29.25px] text-[#29303DB2] text-center lg:text-left">
                    Brawijaya University is one of Indonesia's leading universities, committed to becoming a world-class university. Through the Globalizing UB program, we provide international-quality education that connects students with global opportunities. With over 60 years of experience in education, UB has produced top-notch graduates who contribute to national and international development.
                </p>

                <!-- Stats Icons -->
                <div class="mt-6 lg:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md mx-auto lg:max-w-none lg:mx-0">
                    <div class="flex items-center gap-3 justify-center lg:justify-start">
                        <div class="w-[48px] h-[48px] bg-gradient-to-r from-[#0000FF] to-[#6699FF] rounded-[12px] flex items-center justify-center flex-shrink-0">
                            <img src="{{ asset('icons/user.svg') }}" alt="Students Icon" class="w-[24px] h-[24px]" />
                        </div>
                        <div class="text-center lg:text-left">
                            <p class="font-inter font-bold text-[#29303D] text-lg lg:text-xl">60,000+</p>
                            <p class="font-inter text-[#29303DB2] text-sm lg:text-base">Active Students</p>
                        </div>
                    </div>

                    <div class="flex items-center gap-3 justify-center lg:justify-start">
                        <div class="w-[48px] h-[48px] bg-gradient-to-r from-[#0000FF] to-[#6699FF] rounded-[12px] flex items-center justify-center flex-shrink-0">
                            <img src="{{ asset('icons/globe-blue.svg') }}" alt="Global Icon" class="w-[24px] h-[24px]" />
                        </div>
                        <div class="text-center lg:text-left">
                            <p class="font-inter font-bold text-[#29303D] text-lg lg:text-xl">100+</p>
                            <p class="font-inter text-[#29303DB2] text-sm lg:text-base">Global Partners</p>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Right Container: Image/Additional Content (if needed) -->
