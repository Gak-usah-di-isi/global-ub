                    ...
                    <div
                        ...
                        <section class="mt-4 space-y-2 text-xs sm:text-sm text-gray-500 font-inter">
                            <p class="flex items-center gap-2">
                                <img src="{{ asset(config('app.icon_path') . '/location.svg') }}" alt="Location icon" class="w-4 h-4" />
                                {{ $testimonial->location }}
                            </p>
                            <p class="flex items-center gap-2">
                                <img src="{{ asset(config('app.icon_path') . '/education.svg') }}" alt="Calendar icon" class="w-4 h-4" />
