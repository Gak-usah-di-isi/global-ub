        ...
        <section id="study-in-ub"
            ...
            <div class="max-w-[1280px] mx-auto flex flex-col gap-8 md:gap-12 lg:gap-16">
                ...
                <div class="w-full flex flex-col items-center gap-4">
                    <h2 class="w-full text-center font-playfair font-bold text-2xl md:text-3xl lg:text-[36px] leading-[40px] text-[#29303D]">
                        Study in UB
                    </h2>
                    <p class="max-w-full md:max-w-[768px] text-center font-inter font-light text-base md:text-lg lg:text-[20px] leading-6 md:leading-7 lg:leading-[28px] text-[#29303DB2]">
                        Discover world-class education opportunities and join our diverse international academic community
                    </p>
                </div>

                <div class="w-full mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
                    <div class="flex flex-col items-center">
                        <div class="w-full text-center font-inter font-bold text-2xl md:text-3xl lg:text-[36px] leading-[40px] text-[#0000FF]">
                            150+
                        </div>
                        <span class="mt-1 text-[#29303DB2] font-inter text-sm md:text-[14px] leading-5 md:leading-[20px]">Study Programs</span>
                    </div>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mt-1 text-[#29303DB2] font-inter text-sm md:text-[14px] leading-5 md:leading-[20px]">Faculties</span>
                    </div>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mt-1 text-[#29303DB2] font-inter text-sm md:text-[14px] leading-5 md:leading-[20px]">Partner Universities</span>
                    </div>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mt-1 text-[#29303DB2] font-inter text-sm md:text-[14px] leading-5 md:leading-[20px]">International Students</span>
                    </div>
                </div>

                <div class="w-full mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">

                    <div class="w-full max-w-full sm:max-w-[384px] mx-auto h-auto md:h-[550px] bg-white rounded-2xl shadow-md p-6 md:p-8 flex flex-col gap-4 md:gap-6">
                        <div class="w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center bg-gradient-to-br from-[#0000FF] to-[#6699FF]">
                        ...
                        <ul class="flex flex-col gap-2 mt-2 text-sm md:text-[14px] leading-5 md:leading-[20px] font-inter text-[#29303D]">
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> English-taught courses</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> International faculty</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Exchange opportunities</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Industry partnerships</li>
                        </ul>
                    ...
                    <div class="w-full max-w-full sm:max-w-[384px] mx-auto h-auto md:h-[550px] bg-white rounded-2xl shadow-md p-6 md:p-8 flex flex-col gap-4 md:gap-6">
                        ...
                        <ul class="flex flex-col gap-2 mt-2 text-sm md:text-[14px] leading-5 md:leading-[20px] font-inter text-[#29303D]">
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Two university degrees</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Study abroad experience</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Global network access</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Enhanced career prospects</li>
                        </ul>
                        <a href="#"
                            class="mt-auto w-full h-10 border border-[#E2E4E9] rounded-xl flex items-center justify-center gap-2 px-4 py-2 font-medium text-[#29303D] text-sm md:text-[14px] leading-5 md:leading-[20px]">
                            Learn More
                    ...
                    <div class="w-full max-w-full sm:max-w-[384px] mx-auto h-auto md:h-[550px] bg-white rounded-2xl shadow-md p-6 md:p-8 flex flex-col gap-4 md:gap-6">
                        ...
                        <ul class="flex flex-col gap-2 mt-2 text-sm md:text-[14px] leading-5 md:leading-[20px] font-inter text-[#29303D]">
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Research opportunities</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> International supervision</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Conference participation</li>
                            <li class="flex items-center gap-2"><span class="w-2 h-2 bg-[#0000FF] rounded-full"></span> Publication support</li>
                        </ul>
                        <a href="#"
                            class="mt-auto w-full h-10 border border-[#E2E4E9] rounded-xl flex items-center justify-center gap-2 px-4 py-2 font-medium text-[#29303D] text-sm md:text-[14px] leading-5 md:leading-[20px]">
                            Learn More
                ...
                <div class="w-full flex justify-center items-center py-8">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-2 md:gap-4 bg-[#FFFFFF] rounded-full p-1 md:p-2">
                            <button class="w-7 h-7 md:w-9 md:h-9 bg-[#1D4ED8] text-white rounded-full flex justify-center items-center text-sm md:text-base">
                                1
                            </button>

                            <button class="w-7 h-7 md:w-9 md:h-9 text-[#1D4ED8] flex justify-center items-center text-sm md:text-base">
                                2
                            </button>
                ...
                <div class="w-full max-w-full md:max-w-[1216px] h-auto md:h-[264px] mx-auto bg-white rounded-2xl md:rounded-[24px] p-6 md:p-12 flex flex-col justify-between items-center text-center shadow-lg backdrop-blur-[4px]">
                    <h3 class="text-xl md:text-2xl lg:text-[30px] font-playfair font-bold leading-7 md:leading-8 lg:leading-[36px] text-black">Ready to Start Your Global Journey?
                    </h3>
                    <p class="text-base md:text-lg lg:text-[20px] text-[#29303DB2] font-light font-inter leading-6 md:leading-7 lg:leading-[28px] opacity-90 max-w-full md:max-w-[672px] mt-4">
                        Join thousands of international students who have chosen UB as their gateway to academic and professional success
                    </p>
