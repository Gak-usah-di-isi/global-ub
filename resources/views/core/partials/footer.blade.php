        ...
        <div class="flex flex-col lg:flex-row gap-12">
            <div class="flex flex-col gap-2 w-full lg:w-1/3">
                <div class="flex flex-col gap-4">
                    <div class="flex gap-4 items-center">
                        ...
                        <img src="{{ asset(config('app.icon_path') . '/gub.svg') }}" alt="Globalizing Logo"
                ...
                <div class="flex flex-col gap-4 mt-4">
                    ...
                    <div class="flex items-start gap-2">
                        <img src="{{ asset(config('app.icon_path') . '/location-blue.svg') }}" alt="Map Icon" class="w-4 h-4 mt-1">
                    ...
                    <div class="flex items-center gap-2">
                        <img src="{{ asset(config('app.icon_path') . '/telp-blue.svg') }}" alt="Phone Icon" class="w-4 h-4">
                        <p class="text-white text-sm font-light font-inter">+62 341 551611</p>
                    </div>

                    <div class="flex items-center gap-2">
                        <img src="{{ asset(config('app.icon_path') . '/email-blue.svg') }}" alt="Email Icon" class="w-4 h-4">
            ...
            <div class="flex flex-col gap-6 w-full lg:w-1/3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <a href="mailto:gub@ub.ac.id"
                        ...
                        <img src="{{ asset(config('app.icon_path') . '/email-blue.svg') }}" alt="Email Icon" class="w-[20px] h-[20px]">
                    ...
                    <a href="https://www.linkedin.com/in/globalizing-ub-94b519385/" target="_blank"
                        class="w-full h-[44px] bg-[#FFFFFF1A] rounded-[12px] flex items-center gap-[12px] px-[12px]">
                        <img src="{{ asset(config('app.icon_path') . '/linkedin-blue.svg') }}" alt="LinkedIn Icon"
                            class="w-[20px] h-[20px]">
                    ...
                    <a href="https://www.instagram.com/globalizingub/" target="_blank"
                        class="w-full h-[44px] bg-[#FFFFFF1A] rounded-[12px] flex items-center gap-[12px] px-[12px]">
                        <img src="{{ asset(config('app.icon_path') . '/ig-blue.svg') }}" alt="Instagram Icon" class="w-[20px] h-[20px]">
                    ...
                    <a href="https://www.youtube.com/@GlobalizingUB" target="_blank"
                        class="w-full h-[44px] bg-[#FFFFFF1A] rounded-[12px] flex items-center gap-[12px] px-[12px]">
                        <img src="{{ asset(config('app.icon_path') . '/yt-blue.svg') }}" alt="YouTube Icon" class="w-[20px] h-[20px]">
            ...
            <div class="flex flex-col gap-4 w-full lg:w-1/3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-white text-sm">
                    <div class="flex items-center gap-2">
                        <img src="{{ asset(config('app.icon_path') . '/user.svg') }}" alt="Visits Today Icon" class="w-4 h-4">
                        <span>{{ number_format($visitsToday) }} Visits Today</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <img src="{{ asset(config('app.icon_path') . '/user.svg') }}" alt="Total Visits Icon" class="w-4 h-4">
                        <span>{{ number_format($totalVisits) }} Visits</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <img src="{{ asset(config('app.icon_path') . '/user.svg') }}" alt="Visitors Today Icon" class="w-4 h-4">
                        <span>{{ number_format($visitorsToday) }} Visitors Today</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <img src="{{ asset(config('app.icon_path') . '/user.svg') }}" alt="Total Visitors Icon" class="w-4 h-4">
