<nav
    ...
    <div class="flex items-center space-x-4">
        ...
        <img src="{{ asset(config('app.icon_path') . '/gub-nav.svg') }}" alt="Logo Gub" class="h-6 md:h-8">
    </div>
    ...
    <div class="flex items-center space-x-4">
        <div class="relative">
            <button id="language-button"
                ...
                <img src="{{ asset(config('app.icon_path') . '/globe.svg') }}" alt="Globe Icon" class="w-4 h-4 md:w-5 md:h-5">
                ...
                <img id="arrow-icon" src="{{ asset(config('app.icon_path') . '/arrow-down.svg') }}" alt="Arrow Down Icon"
